...
class AstronomyAdapter(val astronomyResponseList : List<AstronomyResponse>) : RecyclerView.Adapter<AstronomyAdapter.AstronomyViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AstronomyViewHolder = AstronomyViewHolder(AstronomyListItemBinding.inflate(LayoutInflater.from(parent.context)))
    ...
    inner class AstronomyViewHolder(val binding: AstronomyListItemBinding) : RecyclerView.ViewHolder(binding.root)
}